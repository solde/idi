...
QT_MOC_LITERAL(1, 11, 7), // "sendFOV"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 9), // "new_value"
QT_MOC_LITERAL(4, 30, 6), // "setFOV"
QT_MOC_LITERAL(5, 37, 7) // "new_fov"

    },
    "MyGLWidget\0sendFOV\0\0new_value\0setFOV\0"
    "new_fov"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendFOV((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->setFOV((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::sendFOV)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::sendFOV(int _t1)
{
